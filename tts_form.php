...
<div class="container">
    <div class="center-box">
        ...
        <form id="tts-form" method="post" action="">
            <textarea name="tts_text" id="tts_text" rows="20" placeholder="請輸入要轉換的文字"></textarea><br>
            <!-- 自述統計顯示區 -->
...
<script>
// 取得元素
const textarea = document.getElementById('tts_text');
...
function updateStats() {
    ...
    statsBox.textContent = `字元數：${chars}，單詞數：${words}，句子數：${sentences}`;
}
